...
import {TestTaskSchema, TestTaskPack, TestTaskSets, TestTaskItem} from './model/types/testTask'

export type {TestTaskSchema, TestTaskPack, TestTaskSets, TestTaskItem}
